...
export default function App() {
  ...
  if (session) return <Suspense fallback={<div className="page-loader"><span>Loading command center…</span></div>}><Dashboard session={session} onLogout={() => { localStorage.removeItem('transitsync-session'); setSession(null); }} /></Suspense>;
